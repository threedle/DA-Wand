...
class Mesh:
    ...
    def __init__(self, file=None, opt=None, hold_history=False,
                aug = None, anchor_faces=None, weight_init=None):
        self.vs = self.v_mask = self.filename = self.features = self.edge_areas = None
        self.edges = self.gemm_edges = self.sides = None
        self.pool_count = 0
        fill_mesh(self, file, opt, anchor_faces, weight_init)
        self.export_folder = opt.export_folder
